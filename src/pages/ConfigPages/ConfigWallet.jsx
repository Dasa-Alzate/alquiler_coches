...
const ConfigWallet = ({ active }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-evenly mx-auto mt-5 ml-20">
        <div className="flex flex-col">
          ...
          <div className="flex flex-col">
            <input
              ...
              className="w-[25vh] h-[5vh] text-center bg-neutral-900 rounded-3xl text-lg placeholder:text-gray-400/75 text-gray-100 focus:outline-none shadow-inner-3xl shadow-black/75"
            />
            <input
              type="text"
              placeholder="Card Number"
              className="w-[25vh] h-[5vh] mt-5 text-center bg-neutral-900 rounded-3xl text-lg placeholder:text-gray-400/75 text-gray-100 focus:outline-none shadow-inner-3xl shadow-black/75"
            />
            <div className="flex gap-2 mt-5">
              <input
                ...
                min="2024-01"
                className="w-[15vh] h-[6vh] mr-5 text-center bg-neutral-900 rounded-3xl text-lg placeholder:text-gray-400/75 text-gray-100 focus:outline-none shadow-inner-3xl shadow-black/75 [&::-webkit-calendar-picker-indicator]:invert"
              />
              <input
                type="text"
                placeholder="CVV Code"
                className="w-[15vh] h-[6vh] ml-5 text-center bg-neutral-900 rounded-3xl text-lg placeholder:text-gray-400/75 text-gray-100 focus:outline-none shadow-inner-3xl shadow-black/75"
              />
            </div>
            <input
              type="button"
              value="Editar"
              className="w-[12vh] h-[5vh] bg-primary-700 hover:bg-primary-600 rounded-lg py-1 text-lg px-6 mt-5 shadow-lg shadow-zinc-950/75 cursor-pointer transition-all duration-300"
            />
          </div>
        </div>
        <div className="flex flex-col">
          <div className="flex flex-col gap-5">
            ...
            <input
              type="email"
              placeholder="Email"
              className="w-[25vh] h-[5vh] bg-neutral-900 rounded-3xl text-lg px-6 shadow-inner-3xl shadow-black/75"
            />
          </div>
        </div>

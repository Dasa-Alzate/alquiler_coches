...
const SearchBar = ({type}) => {
  return (
    <form className={"relative flex max-w-96 rounded-full bg-primary-900 h-12 shadow-inner-xl shadow-black/50 border border-black/50 " + (type=="navbar" ? "w-96" : "mx-2")} action="">
